/**
 * Tests that calls that include flags to use documentSequences over the wire protocol actually
...
(function() {
    ...
    assert.eq(usedDocumentSequences_forTesting(findRes),
              false,
    ...
    assert.eq(usedDocumentSequences_forTesting(findResWithDocSeq),
              true,
    ...
    assert.eq(
        usedDocumentSequences_forTesting(aggRes),
        false,
    ...
    assert.eq(
        usedDocumentSequences_forTesting(aggResWithDocSeq),
        true,
    ...
    assert.eq(usedDocumentSequences_forTesting(getMoreRes),
              false,
    ...
    assert.eq(usedDocumentSequences_forTesting(getMoreResWithDocSeq),
              true,
    ...
    assert.eq(usedDocumentSequences_forTesting(aggRes),
              false,
    ...
    getMoreResWithDocSeq = assert.commandWorked(db.runCommand(
        {getMore: cursorId, collection: coll.getName(), tempOptInToDocumentSequences: true}));
    assert.eq(
        usedDocumentSequences_forTesting(getMoreResWithDocSeq),
        true,
    ...
    assert.eq(usedDocumentSequences_forTesting(aggResWithDocSeq),
              true,
